...
import { loginWithSpotify } from "@/app/actions/auth.action";
      ...
      <div className="w-full max-w-[430px] flex flex-col items-center gap-6">
        ...
        <main className="w-full flex flex-col gap-4">
          <form action={loginWithSpotify}>
            <Button type="submit" className="w-full bg-riff-spotify hover:bg-[#1ed760] text-white font-semibold py-6 rounded-full flex items-center justify-center gap-2 text-xl transition-colors cursor-pointer">
              <svg
